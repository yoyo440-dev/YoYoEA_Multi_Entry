...
$sourceMq4 = '/home/anyo_/workspace/YoYoEA_Multi_Entry/MQL4/Experts/YoYoEA_Multi_Entry.mq4'
$targetMq4 = '/mnt/d/Rakuten_MT4/MQL4/Experts/YoYoEA_Multi_Entry.mq4'
...
$logFile   = Join-Path $logDir "YoYoEA_Multi_Entry_$timestamp.log"
